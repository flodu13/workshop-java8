...
public class Stream_01_Test {
    ...
    public void test_stream_filter() throws Exception {
        ...
        List<Pizza> result= pizzas.stream()
				.filter(p -> p.getPrice() >= 1300).collect(Collectors.toList());
    ...
    public void test_stream_filter_and_match() throws Exception {
        ...
        List<Order> result = orders.stream()
        		.filter(order -> order.getCustomer().getFirstname().equals("Johnny") && order.getPizzas().stream().anyMatch(p ->p.getPrice() >=1300)).collect(Collectors.toList());
    ...
    public void test_sorted() throws Exception {
        ...
        List<Order> result = orders.stream()
        		.sorted((o1, o2) ->o1.getCustomer().getLastname().compareTo(o2.getCustomer().getLastname()))
